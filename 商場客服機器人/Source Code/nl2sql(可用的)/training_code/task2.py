...
#             select_result[pair.query_id].update([pair.cond_sql])
            select_result[pair.query_id]= [pair.cond_sql]
            pre_score = score
        # print(pair.query_id, pair.cond_sql, score)
...
task1_file = 'task1_0510_output.json'
...
history = model.fit_generator(tr_qc_pairs_seq, epochs=5, workers=4)
...
final_output_file = 'final_0510_output_v2.json'
