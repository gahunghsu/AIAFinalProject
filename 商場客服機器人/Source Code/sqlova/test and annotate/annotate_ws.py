...
import json
#from stanza.nlp.corenlp import CoreNLPClient#No module named 'stanza.nlp
import stanza
...
if __name__ == '__main__':
    ...
    parser.add_argument('--din', default='./data/WikiSQL-1.1/data', help='data directory') #default='/Users/wonseok/data/WikiSQL-1.1/data'
    parser.add_argument('--dout', default='./data/WikiSQL-1.1/data/wikisql_tok', help='output directory')# default='/Users/wonseok/data/wikisql_tok'
    ...
    for split in args.split.split(','):
        ...
        with open("./data/WikiSQL-1.1/data/dev.jsonl") as fs, open("./data/WikiSQL-1.1/data/dev.tables.jsonl") as ft, open(fout, 'wt') as fo:
            print('loading tables')

            # ws: Construct table dict with table_id as a key.
            tables = {}
            #for line in tqdm(ft, total=count_lines(ftable)):
            for line in tqdm(ft, total=count_lines("./data/WikiSQL-1.1/data/dev.tables.jsonl")):
                d = json.loads(line)
                tables[d['id']] = d
            ...
            for line in tqdm(fs, total=count_lines("./data/WikiSQL-1.1/data/dev.jsonl")):
                cnt += 1
                d = json.loads(line)
            ...
            set CLASSPATH=./stanford2/CoreNLP/*;%CLASSPATH%
            $env:CLASSPATH = "./stanford2/CoreNLP/*;$env:CLASSPATH"
