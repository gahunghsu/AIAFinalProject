...
#跑第一次train_cspider(terminal 4)
python3 train_cspider.py --do_train --seed 1 --bS 4 --tepoch 1 --accumulate_gradients 2 --bert_type_abb uS --fine_tune --lr 0.001 --lr_bert 0.00001 --max_seq_length 222 


#python3 train.py --do_train --seed 1 --bS 4 --tepoch 20 --accumulate_gradients 2 --bert_type_abb uS --fine_tune --lr 0.001 --lr_bert 0.00001 --max_seq_length 222 --trained 
